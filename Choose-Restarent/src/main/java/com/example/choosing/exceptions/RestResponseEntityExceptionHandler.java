...
import com.example.choosing.util.ValidationUtil;
...
public class RestResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
     ...
     * HTTP 404 Not Found
     *
     * @param ex      the com.example.choosing.RestaurantNotFoundException
     * @param request the current request
     * @return a {@code ResponseEntity} instance
     */
     ...
     * HTTP 404 Not Found
     *
     * @param ex      the com.example.choosing.ResourceNotFoundException
     * @param request the current request
     * @return a {@code ResponseEntity} instance
     */
